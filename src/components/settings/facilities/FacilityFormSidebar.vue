...
<template>
  <RightSidebar
    ...
    :description="
      isEdit ? 'Update the facility name.' : 'Add a new facility that businesses can offer.'
    "
  >
        ...
        <FormItem>
          ...
          <FormControl>
            <Input
              ...
              placeholder="e.g. Parking, Swimming Pool, Gym"
              :disabled="loading"
            />
          </FormControl>
          <FormMessage />
    ...
    <template #footer>
      <div class="flex justify-end gap-2">
        ...
        <Button :disabled="loading" @click="onSubmit">
          {{ loading ? 'Saving…' : isEdit ? 'Save Changes' : 'Add Facility' }}
        </Button>
      </div>
    </template>
  </RightSidebar>
