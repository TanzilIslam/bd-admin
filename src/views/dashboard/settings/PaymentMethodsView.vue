...
import PaymentMethodFormSidebar from '@/components/settings/payment-methods/PaymentMethodFormSidebar.vue'
...
const editItem = ref<PaymentMethod | null>(null)
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground">
          Manage payment methods that businesses can accept.
        </p>
      </div>
    ...
    <div class="rounded-md border">
      <Table>
        ...
        <TableBody>
          ...
          <TableEmpty v-else :colspan="3">No payment methods found.</TableEmpty>
        </TableBody>
      </Table>
    </div>
  </div>
