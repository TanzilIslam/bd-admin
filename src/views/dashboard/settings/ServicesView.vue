...
import ServiceFormSidebar from '@/components/settings/services/ServiceFormSidebar.vue'
...
const editItem = ref<Service | null>(null)
  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground">Manage services that businesses can offer.</p>
      </div>
    ...
    <div class="rounded-md border">
      <Table>
        ...
        <TableBody>
          ...
          <TableEmpty v-else :colspan="3">No services found.</TableEmpty>
        </TableBody>
      </Table>
    </div>
  </div>
