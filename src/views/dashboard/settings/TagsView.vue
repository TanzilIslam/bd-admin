...
import TagFormSidebar from '@/components/settings/tags/TagFormSidebar.vue'
...
const editItem = ref<Tag | null>(null)
...
function handleDelete(item: Tag) {
  openDeleteConfirm({
    title: 'Delete Tag',
  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground">Manage tags to categorize businesses.</p>
      </div>
    ...
    <div class="rounded-md border">
      <Table>
        ...
        <TableBody>
          ...
          <TableEmpty v-else :colspan="3">No tags found.</TableEmpty>
        </TableBody>
      </Table>
    </div>
  </div>
