...
import FeatureFormSidebar from '@/components/settings/features/FeatureFormSidebar.vue'
...
const editItem = ref<Feature | null>(null)
...
function handleDelete(item: Feature) {
  openDeleteConfirm({
  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground">Manage features that businesses can highlight.</p>
      </div>
    ...
    <div class="rounded-md border">
      <Table>
        ...
        <TableBody>
          ...
          <TableEmpty v-else :colspan="3">No features found.</TableEmpty>
        </TableBody>
      </Table>
    </div>
  </div>
