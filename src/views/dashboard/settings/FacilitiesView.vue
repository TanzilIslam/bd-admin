...
import FacilityFormSidebar from '@/components/settings/facilities/FacilityFormSidebar.vue'
...
const editItem = ref<Facility | null>(null)
...
function handleDelete(item: Facility) {
  openDeleteConfirm({
  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-muted-foreground">Manage facilities that businesses can offer.</p>
      </div>
    ...
    <div class="rounded-md border">
      <Table>
        ...
        <TableBody>
          ...
          <TableEmpty v-else :colspan="3">No facilities found.</TableEmpty>
        </TableBody>
      </Table>
    </div>
  </div>
